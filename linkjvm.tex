...
The following paper shows a high and low level based implementation of Java\cite{Java} 
integrated into the KIPR\cite{KIPR} Link's\cite{link} build system. Further this papers 
describes of how to write programs in Java\cite{Java} with the LinkJVM and how to get them 
