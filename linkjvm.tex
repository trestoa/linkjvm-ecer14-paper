...
'Programs' on the KIPR\cite{KIPR} Link. All this is done over ssh and scp connections in 
the background.
...
\bibitem{JRE}
  ...
  http://www.oracle.com/technetwork/java/javase/downloads/, March 2014
\bibitem{linkjvm1.0}
  Klein Markus: 'Java on the KIPR Link',
